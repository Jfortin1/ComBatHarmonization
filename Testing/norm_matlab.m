...
dlmwrite('data/testdata_combat_parametric_adjusted_matlab.csv',norm,'delimiter',',','precision','%.14f');
norm = combat(data,batch,mod,0);
dlmwrite('data/testdata_combat_nonparametric_adjusted_matlab.csv',norm,'delimiter',',','precision','%.14f');
mod = [];
norm = combat(data,batch,mod,1);
dlmwrite('data/testdata_combat_parametric_unadjusted_matlab.csv',norm,'delimiter',',','precision','%.14f');
norm = combat(data,batch,mod,0);
dlmwrite('data/testdata_combat_nonparametric_unadjusted_matlab.csv',norm,'delimiter',',','precision','%.14f');
